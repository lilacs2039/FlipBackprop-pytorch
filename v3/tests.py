...
# --------------- unit tests ---------------------------------
assert bnn.Sequential([
            bnn.Binarize(depth_ths=bnn.TH_DEPTH1),
            bnn.BMAB(in_features=1, out_features=8,depth_in_features=1),
            bnn.BMA(in_features=8, out_features=3),]
        ).layers[1].layers[0].path == 'Seq.1-BMAB.0-XnorWeight'
